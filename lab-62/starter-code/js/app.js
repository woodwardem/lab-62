...
let redmond = new CookieStand("Redmond", 15, 28, 4)
let Prineville = new CookieStand("Prineville", 10, 20, 6)
console.log(seattle.locationName)
console.log('min customers per hour: ', seattle.minCustomersPerHour)
console.log('max customers per hour: ', seattle.maxCustomersPerHour)
console.log('avg cookies per sale: ', seattle.avgCookiesPerSale)
